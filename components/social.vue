<template>
    <div id="social" class="md:my-32 py-36 flex flex-col items-center md:grid gap-24 md:gap-12">
        <div class="hidden md:block col-start-1">
            <h6>Okay, so... now if you don’t want to sell me water purifiers...</h6>
        </div>
        <div class="hidden md:block  col-start-2 row-start-2 text-end">
            <h5>
                You can call me at <a href="tel:+393275803778" class="text-green underline">this number</a>!
            </h5>
        </div>
        <div class="md:col-start-1 md:row-start-3 col-span-2 max-w-sm">
            <h4 class="hidden md:block">But If you want to find out more, check out my social links to...</h4>
